...
interface NotificationContextType {
  ...
  // helpers específicas para TrueStock
...
// ---- mocks iniciales (solo si no hay nada guardado) ----
...
export const NotificationProvider: React.FC<NotificationProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    try {
      ...
      if (raw) {
        const parsed = JSON.parse(raw) as (Omit<Notification, 'timestamp'> & { timestamp: string })[]
